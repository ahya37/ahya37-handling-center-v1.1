        ...
        <div class="page-content">
            <h5>ANALITIK SOP</h6>
                {{-- <ul style="list-style-type:circle">
                    <li>
                        Grafik yang ditampilkan adalah data penilaian dari semua penugasan muthowwif
                    </li>
                </ul> --}}
                <hr />
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                    <select id="muthowwif" class="single-select muthowwif @error ('muthowwif') is-invalid @enderror" name="muthowwif"></select>
                            </div>
                            {{-- <div class="col-md-3">
    ...
    {{-- <div class="switcher-wrapper">
        ...
        <div class="switcher-body">
            ...
            <div class="d-flex align-items-center justify-content-between mt-2">
                <div class="col-md-12">
                    <select id="muthowwif" class="single-select muthowwif @error('muthowwif') is-invalid @enderror"
                        name="muthowwif"></select>
                </div>
            </div>
            <div class="d-flex align-items-center justify-content-between mt-2">
                <div class="col-md-12">
...
@push('scripts')
    ...
    <script src="{{ asset('js/dashboard-analytics-muthowwif.js') }}"></script>
@endpush
