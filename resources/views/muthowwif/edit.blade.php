                            ...
                            <div class="card border-top border-0 border-4 border-primary">
                                <div class="card-body p-5">
                                    <div class="card-title d-flex align-items-center">
                                        <h5 class="mb-0 text-primary"> Edit Muthowwif</h5>
                                    </div>
                                    <hr>
                                    <form class="row g-3" action="{{ route('muthowwif.update', $pembimbing->id) }}" method="post" enctype="multipart/form-data">
                                        @csrf
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="alert alert-info border-0 bg-info alert-dismissible fade show">
                                                    <div class="text-white">Email ini digunakan untuk login muwhowwif, contoh: namamuthowwif@percik.com</div>
                                            </div>
