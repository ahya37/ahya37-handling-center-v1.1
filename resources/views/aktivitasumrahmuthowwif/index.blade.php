...
<div class="page-wrapper">
        ...
        @include('layouts.message')
				<h6 class="mb-0 ">Tugas Muthowwif Umrah</h6>
				<hr/>
				<div class="card">
					<div class="card-body">
						<div class="row">
							...
							<div class="col-md-1 mt-1">
								<a href="{{ route('muthowwif.jadwaltugas.create') }}" class="btn btn-sm float-right mb-4 text-primary" title="Tambah Baru"><i class="lni lni-circle-plus"></i> </a>
							</div>
						</div>
						<hr>
...
<script src="{{ asset('/js/activitas-umrah-muthowwif.js') }}"></script>
@endpush 