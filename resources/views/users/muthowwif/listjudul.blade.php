				...
				<div class="alert border-0 border-start border-5 border-success alert-dismissible fade show py-2">
				   <div class="d-flex align-items-center">
					...
					<div class="d-flex align-items-center">
						...
						<div class="ms-3">
							<div>
								<a href="{{route('user.muthowwif.aktivitas.judul.detail', ['aktitivitas_umrah_id' => $aktitivitas_umrah_id,'id' => $list->id ] )}}" class="mt-2 btn btn-sm btn-secondary">{{$list->nama}}</a>
							</div>
						</div>
					 </div>
					 @else 
					 <div class="d-flex align-items-center">
						 ...
						 <div class="ms-3">
							 <div>
								 <a href="{{route('user.muthowwif.aktivitas.judul.detail', ['aktitivitas_umrah_id' => $aktitivitas_umrah_id,'id' => $list->id ] )}}" class="mt-2 btn btn-sm btn-primary">{{$list->nama}}</a>
							 </div>
						 </div>
					  </div>
					@endif
