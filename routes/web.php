...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::group(['prefix' =>  'aktivitas'], function(){
        ...
        Route::get('/tourcode/kuisioner/umrah/{umrahid}/aktivitasumrahid/{aktivitasumrahid}', 'AktivitasUmrahController@kuisionerByTourcodePembimbing')->name('aktivitas.kuisioner.detail');
